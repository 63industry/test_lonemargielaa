...
export const t = {
  ...
  hero: {
    tagline: { en: "Photographer / Videographer — Fribourg (CH)", fr: "Photographe / Vidéaste — Fribourg (CH)" },
    desc:    { en: "I capture the raw energy of streetwear, rap music videos and urban culture. Hard-hitting visuals for the artists and brands who aren't afraid of the dark.", fr: "Je capture l'énergie brute du streetwear, des clips rap et de la culture urbaine. Des visuels percutants pour les artistes et marques qui n'ont pas peur du sombre." },
  ...
  about: {
    ...
    desc:    { en: "Just a young creativo — versatile and capable of telling very different universes while keeping a strong visual identity.", fr: "Juste un jeune créatuff — polyvalent, capable de raconter des univers très différents tout en conservant une identité visuelle forte !" },
  ...
  contact: {
    ...
    desc:    { en: "A music video, a brand shoot or an event to immortalize? Describe your project and I'll get back to you fast.", fr: "Un clip, un shooting de marque ou un événement à immortaliser ? Décris ton projet et je te réponds vite." },
    name:    { en: "Name",             fr: "Nom" },

        ...
        <div className="mt-10 grid grid-cols-2 gap-4 sm:grid-cols-4 sm:grid-rows-3">
          ...
          <article className="group relative col-span-2 row-span-3 overflow-hidden border border-border aspect-square sm:aspect-auto">
            ...
            <div className="absolute inset-x-0 bottom-0 p-4">
              <p className="font-display text-3xl uppercase tracking-tight sm:text-5xl">Housmatikee</p>
              <p className="font-mono text-[0.7rem] uppercase tracking-[0.2em] text-acid">12 (feat. HaitienBourgeois)</p>
            </div>
          </article>
          ...
          <article className="group relative col-span-2 overflow-hidden border border-border aspect-[2/1]">
            ...
            <div className="absolute inset-x-0 bottom-0 p-4">
              ...
              <p className="font-mono text-[0.7rem] uppercase tracking-[0.2em] text-acid">À La Télé</p>
            </div>
          </article>

          {/* Expressway — photo, wide */}
          <article className="group relative col-span-2 overflow-hidden border border-border aspect-[2/1]">
            <img src={tk8} alt="Expressway" loading="lazy" className="h-full w-full object-cover contrast-125 brightness-90 transition-all duration-700 group-hover:scale-105 group-hover:brightness-110" />
            <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-transparent to-transparent" />
            <div className="absolute inset-x-0 bottom-0 p-4">
              <p className="font-display text-lg uppercase tracking-tight">Expressway</p>
              <p className="font-mono text-[0.7rem] uppercase tracking-[0.2em] text-acid">Cityscape</p>
            </div>
          </article>

          {/* Shutokō — photo, wide */}
          <article className="group relative col-span-2 overflow-hidden border border-border aspect-[2/1]">
            <img src={tk5} alt="Shutokō" loading="lazy" className="h-full w-full object-cover contrast-125 brightness-90 transition-all duration-700 group-hover:scale-105 group-hover:brightness-110" />
            <div className="absolute inset-0 bg-gradient-to-t from-background/90 via-transparent to-transparent" />
            <div className="absolute inset-x-0 bottom-0 p-4">
              <p className="font-display text-lg uppercase tracking-tight">Shutokō</p>
              <p className="font-mono text-[0.7rem] uppercase tracking-[0.2em] text-acid">Aerial / Night</p>
            </div>
          </article>
        </div>
      </div>
